...
class ProfessorFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pis' => 'required|digits_between:11,11|numeric',
            'dob' => 'required', 'date',
            'user_id' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'pis.required' => 'O campo PIS é obrigatorio',
            'pis.digits_between' => 'O campo PIS necessita de 11 digitos',
            'pis.numeric' => 'O campo PIS deve ser preenchido apenas com numeros',
